...
module HsUtils(
  ...
  -- Template Haskell
  mkHsSpliceTy, mkHsSpliceE, mkHsSpliceTE, mkUntypedSplice, mkTypedSplice,
...
mkHsSpliceTE hasParen e = HsSpliceE noExt (mkTypedSplice hasParen e)
...
makeFunBind :: Located RdrName -> [LMatch GhcPs (LHsExpr GhcPs)]
            -> HsBind GhcPs
-- Like mkFunBind, but we need to be able to set the fixity too
makeFunBind fn ms
